...
## Frutiger Motions
- <kbd>shift</kbd>:* select, invert, intensify, 2nd function
- <kbd>alt</kbd>: navigation 
- <kbd>ctrl<kbd>: modification, mode switching, jumping
...
## Potentials
🔳 <kbd>ctrl+tab</kbd> triggers autocompletion, intellisense
